...
public interface Decompiler
{
    ...
    public static interface Type
    {
         ...
         */
        public void decompileClassFile(File srcClassFile, File destFile, DecompilationConf conf)
    ...
    public static interface Jar
    {
         ...
         * 
         * @param srcDir
         * @param destDir Where to put the decompiled .java files. Sources from archives will be put into the same named
         *            directories, e.g. foo.ear/bar.jar/src/com/foo/bar/Baz.java
         */
        public JarDecompilationResults decompileJar(File srcJar, File destDir, DecompilationConf conf)
                    throws DecompilationException;
    }
