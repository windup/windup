...
public class GraphVisitorSorter
{
    ...
    /**
     * Returns a list of visitors, sorted by the phase and dependency. Note that this does _not_ modify the originally
     * passed in list.
     * 
    ...
    public List<GraphVisitor> sort(List<GraphVisitor> graphVisitorList)
    {
        ...
        DefaultDirectedWeightedGraph<Class<? extends GraphVisitor>, DefaultEdge> g = new DefaultDirectedWeightedGraph<>(
                    DefaultEdge.class);
        ...
        for (GraphVisitor v : tempList)
        {
            ...
            Class<? extends GraphVisitor> unproxiedClass = (Class<? extends GraphVisitor>) Proxies.unwrapProxyTypes(v
                        .getClass());
        ...
        for (GraphVisitor v : tempList)
        {
            ...
            {
                @SuppressWarnings("unchecked")
                Class<? extends GraphVisitor> unproxiedPreviousClass = (Class<? extends GraphVisitor>) Proxies
        ...
        TopologicalOrderIterator<Class<? extends GraphVisitor>, DefaultEdge> iterator = new TopologicalOrderIterator<>(
                    g);
