== reporting
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The reporting addon enables blah blah...)
...
----
<dependency>
   <groupId>org.jboss.windup.engine.core.reporting</groupId>
