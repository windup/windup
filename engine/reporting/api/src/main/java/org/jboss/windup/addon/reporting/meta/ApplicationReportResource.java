...
public interface ApplicationReportResource extends ReportResource
{
    ...
    public Iterable<ReportResource> getChildReports();
    
    @Adjacency(label="childReport", direction=Direction.OUT)
    public void addChildrenArchiveEntries(final ReportResource reportResource);
