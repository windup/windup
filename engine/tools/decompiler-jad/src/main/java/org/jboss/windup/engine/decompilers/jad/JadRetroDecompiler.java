package org.jboss.windup.engine.decompilers.jad;
 ...
 */
public class JadRetroDecompiler implements IDecompiler.Conf<JadConf>, IDecompiler.Jar, IDecompiler.Type {
     ...
     */
    @Override
    public void decompileClassFile( File classFile, File destDir, DecompilationConf conf_) throws DecompilationPathEx
    {
        ...
        try {
            ...
            throw new DecompilationPathEx( msg, classFile.getPath(), ex );
        }
    ...
    public JarDecompilationResults decompileJar( File jarFile, File destDir, DecompilationConf conf_ ) throws DecompilationEx {
        ...
        while( entries.hasMoreElements() ) {
            ...
            try {
                ...
                throw new DecompilationPathEx("Error extracting .class: " + ex.getMessage(), subPath, ex);
            }
            ...
            try {
                ...
                DecompilationPathEx ex = new DecompilationPathEx( msg, subPath, th );
                log.error(msg, ex);
                res.addFailed( ex );
            }
     ...
     */
    private static void executeJad( File classFile, File destDir ) throws DecompilationPathEx
    {
        ...
        try
        {
            ...
            log.error( out);
            log.error( msg );
            throw new DecompilationPathEx( msg + "\n" + out, classFile.getPath(), ex );
        }
        catch( IOException ex ) {
            String out = ("Jad output:\n" + sb.toString()).replace(".class...", ".class...\n");
            String msg = "Error running the decompiler on: " + classFile.getAbsolutePath()
