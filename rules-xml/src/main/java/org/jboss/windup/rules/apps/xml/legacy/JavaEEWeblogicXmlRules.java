 ...
 *
 */
public class JavaEEWeblogicXmlRules extends WindupRuleProvider
{
    @Override
    public void enhanceMetadata(Context context)
    {
        super.enhanceMetadata(context);
        context.put(RuleMetadata.CATEGORY, "JavaEE/WebLogic");
    }
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        Configuration configuration = ConfigurationBuilder
            ...
            .when(XmlFile.matchesXpath("/*[local-name()='weblogic-rdbms-jar']").namespace("wle",
                ...
                .or(XmlFile.from("1").matchesXpath("//*[@value='delay-updates-until-end-of-tx']/text()").as("2"))
                .or(XmlFile.from("2").withDTDPublicId("delay-updates-until-end-of-tx$").as("3")))
            ...
            .when(XmlFile.matchesXpath("/wl:weblogic-webservices | /wl9:weblogic-webservices")
                        ...
                        .or(XmlFile.from("1").matchesXpath("//wl:webservice-type | //wl9:webservice-type")
                                    .namespace("wl", "http://www.bea.com/ns/weblogic/weblogic-webservices")
            ...
            .addRule()
            .when(XmlFile
                        .matchesXpath("/bea:weblogic-web-app | /wlso:weblogic-web-app | /wls:weblogic-web-app | /weblogic-web-app")
