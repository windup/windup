 ...
 *
 */
public class XmlBasicClassificationRuleProvider extends WindupRuleProvider
{
    @Override
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        ...
        .begin()
        .addRule()
        .when(XmlFile.matchesXpath("/j2ee:taglib | /taglib").namespace("j2ee", "http://java.sun.com/xml/ns/j2ee"))
        ...
        .addRule()
        .when(XmlFile.matchesXpath("/*[local-name()='binding']/*[local-name()='namespace'] | /*[local-name()='binding']/*[local-name()='mapping']/@value-style | /*[local-name()='binding']/*[local-name()='mapping']/*[local-name()='value']/@style | /*[local-name()='binding']/*[local-name()='mapping']/@value"))
        ...
        .addRule()
        .when(XmlFile.matchesXpath("/xslt:stylesheet").namespace("xslt", "http://www.w3.org/1999/XSL/Transform"))
        .perform(Classification.as("XSLT Configuration").withEffort(0))
        .addRule()
        .when(XmlFile.matchesXpath("/jee:facelet-taglib | /facelet-taglib | /*[local-name()='facelet-taglib']")
        ...
        .addRule()
        .when(XmlFile.matchesXpath("/jbpm31:process-definition | /process-definition/start-state | /jbpm32:process-definition")
        ...
        .addRule()
        .when(XmlFile.matchesXpath("/cbf:binding").namespace("cbf", "http://www.castor.org/SourceGenerator/Binding"))
        ...
        .addRule()
        .when(XmlFile.matchesXpath("/configuration/appender/@class | /configuration/logger | /log4j:configuration")
        ...
        .addRule()
        .when(XmlFile.matchesXpath("/pmd:ruleset | /pmd").namespace("pmd", "http://pmd.sf.net/ruleset/1.0.0"))
