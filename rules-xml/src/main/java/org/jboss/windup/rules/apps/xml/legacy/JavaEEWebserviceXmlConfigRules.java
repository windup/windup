 ...
 *
 */
public class JavaEEWebserviceXmlConfigRules extends WindupRuleProvider
{
    @Override
    public void enhanceMetadata(Context context)
    {
        super.enhanceMetadata(context);
        context.put(RuleMetadata.CATEGORY, "JavaEE/WebServices/XML");
    }
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        ...
        .when(XmlFile.matchesXpath("/jee:webservices | /j2e:webservices")
                    ...
                    .or(XmlFile.from("1").matchesXpath("//jee:handler-class | //j2e:handler-class").namespace("jee", "http://java.sun.com/xml/ns/javaee")
                                .namespace("j2e", "http://java.sun.com/xml/ns/j2ee").as("2"))
                    .or(XmlFile.from("1").matchesXpath("//jee:service-endpoint-interface | //j2e:service-endpoint-interface").namespace("jee", "http://java.sun.com/xml/ns/javaee")
