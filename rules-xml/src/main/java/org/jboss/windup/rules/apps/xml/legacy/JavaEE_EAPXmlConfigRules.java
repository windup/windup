...
/**
 * Rules for JBoss EAP XML configuration.
 * @author <a href="mailto:mbriskar@gmail.com">Matej Briškár</a>
 */
public class JavaEE_EAPXmlConfigRules extends WindupRuleProvider
{
    @Override
    public void enhanceMetadata(Context context)
    {
        super.enhanceMetadata(context);
        context.put(RuleMetadata.CATEGORY, "JavaEE/EAP/XML");
    }
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        ...
        .perform(Hint.withText("Define this attribute as one parameter with CLI."))
        .addRule()
        .when(XmlFile.matchesXpath("//datasources/local-tx-datasource/connection-url[contains(text(),'jdbc:postgres')]")
                    .inFile(".*-ds.xml"))
        .perform(Hint.withText("Manually port datasource settings"))
        .addRule()
        .when(XmlFile.matchesXpath("//datasources/local-tx-datasource/connection-url[contains(text(),'jdbc:oracle')]")
                    .inFile(".*-ds.xml"))
        .perform(Hint.withText("Manually port datasource settings"))
        .addRule()
        .when(XmlFile.matchesXpath("//datasources/local-tx-datasource/connection-url[contains(text(),'jdbc:sqlserver')]")
                    .inFile(".*-ds.xml"))
        .perform(Hint.withText("Manually port datasource settings"))
        .addRule()
        ...
        .addRule()
        .when(XmlFile.matchesXpath("//jboss/container-configurations/container-configuration[@extends='Standard Stateless SessionBean']")
                    .inFile("jboss.xml"))
        .perform(Hint.withText("Bean-specific instance pool can be set with one line in management CLI"))
        .addRule()
        .when(XmlFile.matchesXpath("//jboss/container-configurations/container-configuration[@extends='Clustered Stateless SessionBean']")
                    .inFile("jboss.xml"))
        .perform(Hint.withText("Bean-specific instance pool can be set with one line in management CLI"))
        .addRule()
        .when(XmlFile.matchesXpath("//jboss/container-configurations/container-configuration[@extends='Standard Message Driven Bean']")
                    .inFile("jboss.xml"))
        .perform(Hint.withText("MDB's Bean-specific instance pool can be set with one line in management CLI"))
        .addRule()
        .when(XmlFile.matchesXpath("//jboss/container-configurations/container-configuration[@extends='Singleton Message Driven Bean']")
                    .inFile("jboss.xml"))
        ...
        .addRule()
        .when(XmlFile.matchesXpath("//jboss/container-configurations/container-configuration[@extends='Standard Message Inflow Driven Bean']")
                    .inFile("jboss.xml"))
