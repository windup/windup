            ...
            IteratingRuleProvider<ArchiveModel>
{
                ...
                ArchiveModel payload)
    {
        ...
        for (FileModel license : licenseFiles)
        {
            ...
            try (InputStream stream = license.asInputStream())
            {
                ...
                {
                    ClassificationModel classificationModel = tagLicense(classificationService, linkService, licenseService, technologyTagService, license,
                                "Apache License 2.0",
                                "Apache License 2.0 File",
                                "http://www.apache.org/licenses/LICENSE-2.0");

                    addLink(linkService, classificationModel, "http://en.wikipedia.org/wiki/Apache_License", "Apache License Wikipedia");
                    addLink(linkService, classificationModel, "http://www.apache.org/licenses/", "Apache License Website");
                }
                            ...
                            "GNU General Public License"))
                {
                    ...
                    addLink(linkService, classificationModel, "http://en.wikipedia.org/wiki/GNU_General_Public_License", "GNU License Wikipedia");
                            ...
                            "The MIT License (MIT)"))
                {
                    ...
                    addLink(linkService, classificationModel, "http://en.wikipedia.org/wiki/MIT_License", "MIT License Wikipedia");
                            ...
                            "Mozilla Public License, version 2.0"))
                {
                    ...
                    addLink(linkService, classificationModel, "http://en.wikipedia.org/wiki/Mozilla_Public_License", "Mozilla License Wikipedia");
                }
                else if (StringUtils.containsIgnoreCase(content,
                            "GNU Lesser General Public License"))
                {
                    ...
                    addLink(linkService, classificationModel, "http://en.wikipedia.org/wiki/GNU_Lesser_General_Public_License",
                            ...
                            "COMMON DEVELOPMENT AND DISTRIBUTION LICENSE"))
                {
                    ...
                    addLink(linkService, classificationModel, "http://en.wikipedia.org/wiki/Common_Development_and_Distribution_License",
                                "CDDL Wikipedia");
                            ...
                            "Eclipse Public License"))
                {
                    ...
                    addLink(linkService, classificationModel, "http://en.wikipedia.org/wiki/Eclipse_Public_License",
                    ...
                    addLink(linkService, classificationModel, "http://en.wikipedia.org/wiki/BSD_licenses",
    ...
    private ClassificationModel tagLicense(ClassificationService classificationService, LinkService linkService, GraphService<LicenseModel> licenseService,
    ...
    private void addLink(LinkService linkService, ClassificationModel classificationModel, String url, String description)
    {
