...
public interface JavaClassBuilder extends ConditionBuilder
{
    ...
    /**
     * Specify a regex that filters against {@link JavaSourceFileModel#getPrettyPathWithinProject()}. (E.g. The fully qualified type name.)
     */
    JavaClassBuilder inType(String regex);
}