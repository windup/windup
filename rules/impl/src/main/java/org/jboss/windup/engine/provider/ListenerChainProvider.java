...
import org.jboss.windup.engine.visitor.inspector.ArchiveEntryIndexVisitor;
import org.jboss.windup.engine.visitor.inspector.ArchiveHashVisitor;
import org.jboss.windup.engine.visitor.inspector.ArchiveTypingVisitor;
import org.jboss.windup.engine.visitor.inspector.BasicVisitor;
import org.jboss.windup.engine.visitor.inspector.DebugVisitor;
import org.jboss.windup.engine.visitor.inspector.EjbConfigurationVisitor;
import org.jboss.windup.engine.visitor.inspector.HibernateConfigurationVisitor;
import org.jboss.windup.engine.visitor.inspector.HibernateMappingVisitor;
import org.jboss.windup.engine.visitor.inspector.JavaClassVisitor;
import org.jboss.windup.engine.visitor.inspector.ManifestVisitor;
import org.jboss.windup.engine.visitor.inspector.MavenFacetVisitor;
import org.jboss.windup.engine.visitor.inspector.SpringConfigurationVisitor;
import org.jboss.windup.engine.visitor.inspector.WebConfigurationVisitor;
...
public class ListenerChainProvider
{
   ...
   public List<GraphVisitor> getListenerChain()
   {
      ...
      // listenerChain.add(new DebugVisitor(context, SpringConfigurationFacet.class)); //extract Maven information to
      // facet.
