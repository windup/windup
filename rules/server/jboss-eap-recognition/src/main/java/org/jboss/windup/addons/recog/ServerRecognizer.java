...
public class ServerRecognizer
{
    ...
    // public enum ServerType { JBOSS_AS, TOMCAT, WEBSPHERE, WEBLOGIC, GLASSFISH }; // Should rather be classes, to make
    // it pluginable.
     ...
     */
    public static IServerType recognizeType(File serverRootDir) throws WindupException
    {
     ...
     */
    private VersionRange recognizeVersion(Class<? extends IServerType> typeClass, File serverRootDir)
     ...
     * All-in-one.
     */
    public static ServerInfo recognize(File serverRootDir) throws WindupException
    {
    ...
    /**
     * Finds classes implementing IServerType. Currently static.
     */
     ...
     */
    private static IServerType instantiate(Class<? extends IServerType> typeClass) throws WindupException
    {
        try
        {
        ...
        {
            throw new WindupException("Failed instantiating ServerType " + typeClass.getSimpleName() + ": "
                        + ex.getMessage(), ex);
        }
    }
