...
public class ServerInfo
{
    ...
    @XmlAttribute
    // @XmlJavaTypeAdapter(FileToPathAdapter.class)
    ...
    public void compareHashes() throws WindupException
    {
        if (!(this.type instanceof HasHashes))
            throw new WindupException("Comparison of file hashes is not supported for server type '"
    ...
    public ServerInfo setType(IServerType type)
    {
        this.type = type;
        return this;
    }
