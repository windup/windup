...
public class XmlSoa5Config extends WindupRuleProvider
{
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        Configuration configuration = ConfigurationBuilder
                    ...
                    .perform(Hint.in("1").withText("Action : convert action class").withEffort(1)
                                .and(Hint.in("2").withText(" Custom action classes should be migrated to CDI Beans in SOA\n" + 
                                            "                    6. These beans\n" + 
                    ...
                    .perform(Classification.as("Action : create component service for action processing pipeline")
                                .withEffort(1).and(Hint.in("2").withText("The logic and execution flow of a service in SOA 5 is defined\n" + 
                                            "                    in an\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : composite service required for service").withEffort(1)
                                .and(Hint.in("2").withText(" Each &lt;service&gt; definition in SOA 5 represents a service\n" + 
                                            "                    which can be\n" + 
                                 ...
                                 .and(Hint.in("3").withText("value : jms Listener name").withEffort(1)))
                    .addRule()
                    ...
                    .perform(Hint.in("1").withText("Action : composite service binding required for listener")
                                .withEffort(1).and(Hint.in("2").withText("This listener requires a composite service binding in\n" + 
                                            "                    SwitchYard. The\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : service binding configuration in hibernate-bus")
                                .withEffort(1).and(Hint.in("2").withText(" Although Camel has both hibernate and jpa components that are\n" + 
                                            "                    useful\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : service binding configuration in jms-bus").withEffort(1)
                                .and(Hint.in("2").withText(" A jms-bus definition can be converted to a JMS or JCA gateway\n" + 
                                            "                    binding\n" + 
                                ...
                                .and(Hint.in("3").withText("Value : Composite-service-name").withEffort(1))))
                    .addRule()
                    ...
                    .perform(Hint.in("1").withText("Action : service binding configuration in ftp-bus").withEffort(1)
                                .and(Hint.in("2").withText("A ftp-bus definition can be converted to a FTP gateway\n" + 
                                            "                    binding\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : service binding configuration in ftp-bus").withEffort(1)
                                .and(Hint.in("2").withText("A camel-bus definition can be converted to a Camel gateway\n" + 
                                            "                    binding\n" + 
                                            "                    on a composite service in SwitchYard.\n" + 
                                            "\n" + 
                                            "                    For additional information and tips, see the\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : service binding configuration in udp-listener")
                                .withEffort(1).and(Hint.in("2").withText("A udp-listener definition can be converted to a TCP/UDP\n" + 
                                            "                    gateway binding\n" + 
                                            "                    on a composite service in SwitchYard.")))
                    .addRule()
                    ...
                    .perform(Hint.in("1").withText("Action : composite service binding required for listener")
                                .withEffort(1).and(Hint.in("2").withText("A jms-jca-provider definition can be converted to a JCA\n" + 
                                            "                    gateway binding\n" + 
                                            "                    on a composite service in SwitchYard.")))
                    .addRule()
                    ...
                    .perform(Hint.in("1").withText("Action : composite service binding required for listener")
                                .withEffort(1).and(Hint.in("2").withText(" A http-provider definition can be converted to a HTTP gateway\n" + 
                                            "                    binding\n" + 
                                            "                    on a composite service in SwitchYard.\n" + 
                                            "\n" + 
                                            "                    For additional information and tips, see the &lt;a\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : service binding configuration in ftp-bus").withEffort(1)
                                .and(Hint.in("2").withText(" A cron-schedule definition can be converted to a Quartz\n" + 
                                            "                    gateway binding\n" + 
                                            "                    on a composite service in SwitchYard.\n" + 
                                            "\n" + 
                                            "                    For additional information and tips, see the\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : composite service binding required for listener")
                                .withEffort(1).and(Hint.in("2").withText("This gateway requires a composite service binding in\n" + 
                                            "                    SwitchYard. The\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : replace with HTTP binding").withEffort(1)
                                .and(Hint.in("2").withText(" A &lt;http-gateway&gt; can be replaced in SwitchYard by a\n" + 
                                            "                    http\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert SmooksAction to Transform").withEffort(1)
                                .and(Hint.in("2").withText("SwitchYard uses a &lt;transform&gt; to replace the invocation\n" + 
                                            "                    of as SmooksAction\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : Smooks config conversion").withEffort(1)
                                .and(Hint.in("2").withText("In a SwitchYard Smooks transform, you can specify your Smooks\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert SOAPProxy").withEffort(1)
                                .and(Hint.in("2").withText("Instead of the JBoss ESB SOAPProxy action which transforms a\n" + 
                                            "                    specified\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert SystemPrintln").withEffort(1)
                                .and(Hint.in("2").withText("In order to log your message (or a static logging message),\n" + 
                                            "                    you\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert StaticRouter to Camel routing").withEffort(1)
                                .and(Hint.in("2").withText("In order to configure static routes for your message in\n" + 
                                            "                    SwitchYard, you\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert JMSRouter").withEffort(1)
                                .and(Hint.in("2").withText("In order to replace the use of the JMSRouter in SwitchYard,\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : remove TestMessageStore").withEffort(1)
                                .and(Hint.in("2").withText("TestMessageStore is a out-of-the-box ESB action that is used\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : replace GroovyActionProcessor with Camel").withEffort(1)
                                .and(Hint.in("2").withText(" The GroovyActionProcessor action executes a Groovy script.\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : Replace BpmProcessor").withEffort(1)
                                .and(Hint.in("2").withText("The BpmProcessor makes calls to jBPM 3 through the jBPM\n" + 
                                            "                    command API.\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : service binding configuration in fs-bus").withEffort(1)
                                .and(Hint.in("2").withText("A fs-bus definition can be converted to a Camel binding\n" + 
                                            "                    on a\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert Notifiers to bindings").withEffort(1)
                                .and(Hint.in("2").withText("JBoss ESB uses notifiers to transform ESB aware messages to a\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert ByteArrayToString to bindings").withEffort(1)
                                .and(Hint.in("2").withText(" JBoss ESB uses a ByteArrayToString action to do conversion on\n" + 
                                            "                    a message body.\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert LongToDateConverter to a Camel type conversion")
                                .withEffort(1).and(Hint.in("2").withText("JBoss ESB uses the LongToDateConverter action to do\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert ObjectToCSVString to a Camel type conversion")
                                .withEffort(1).and(Hint.in("2").withText(" JBoss ESB uses the ObjectToCSVString action to do conversion\n" + 
                                            "                    on a message body.\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert ObjectInvoke to a bean service").withEffort(1)
                                .and(Hint.in("2").withText("JBoss ESB uses a ObjectInvoke action to do invoke a processor\n" + 
                                            "                    on a message.\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert ObjectToXStream to a transform").withEffort(1)
                                .and(Hint.in("2").withText("JBoss ESB uses a ObjectToXStream action to do convert an\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert XStreamToObject to a transform").withEffort(1)
                                .and(Hint.in("2").withText("JBoss ESB uses a XStreamToObject action to convert XML in a\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert XsltAction to a transform").withEffort(1)
                                .and(Hint.in("2").withText("JBoss ESB uses a XStreamToObject action to convert XML in a\n" + 
                                            "                    payload to an object using the\n" + 
                                            "                    XStream processor. SwitchYard would use Camel or a possibly a Smooks\n" + 
                                            "                    transform to do this sort of conversion.\n" + 
                    ...
                    .when(XmlFile
                                ...
                                .as("1").and(XmlFile.from("1").matchesXpath("//*[local-name()='action' and @class='org.jboss.soa.esb.actions.transformation.xslt.XsltAction']/@class").resultMatches(".*").as("2")))
                    .perform(Hint.in("1").withText("Action : convert XsltAction to a transform").withEffort(1)
                                .and(Hint.in("2").withText("JBoss ESB uses the XsltAction action to transform documents\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert SmooksTransformer to Transform").withEffort(1)
                                .and(Hint.in("2").withText("SwitchYard uses a &lt;transform&gt; to replace the invocation\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert MessagePersister to SQL binding").withEffort(1)
                                .and(Hint.in("2").withText("SwitchYard uses the MessagePersister action to persist a\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : replace EJBProcessor with a bean service").withEffort(1)
                                .and(Hint.in("2").withText("JBoss ESB uses the EJBProcessor action to invoke a stateless\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : replace ScriptingAction with Camel").withEffort(1)
                                .and(Hint.in("2").withText("The ScriptingAction executes a script using the\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : replace Aggregator with Camel Aggregator").withEffort(1)
                                .and(Hint.in("2").withText("JBoss ESB uses the Aggregator action to aggregate a message\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : replace Streaming Aggregator with Camel Aggregator")
                                .withEffort(1).and(Hint.in("2").withText("JBoss ESB uses the StreamingAggregator action to aggregate a\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert HttpRouter").withEffort(1)
                                .and(Hint.in("2").withText("In order to replace the use of the HttpRouter in SwitchYard,\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert EmailRouter").withEffort(1)
                                .and(Hint.in("2").withText("In order to replace the use of the EmailRouter in SwitchYard,\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert ContentBasedRouter").withEffort(1)
                                .and(Hint.in("2").withText("In order to replace the use of the ContentBasedRouter in\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert StaticWiretap").withEffort(1)
                                .and(Hint.in("2").withText("In order to replace the use of the StaticWiretap in\n" + 
                                            "                    SwitchYard, you should use Camel to route\n" + 
                                            "                    messages.")))
                    .addRule()
                    .when(XmlFile
                                .matchesXpath(
                                            "//*[local-name()='action' and @class='org.jboss.soa.esb.actions.StaticRouter']/@class")
                                .as("1").and(XmlFile.from("1").matchesXpath( "//*[local-name()='action' and @class='org.jboss.soa.esb.actions.StaticRouter']/@class").resultMatches(".*").as("2")))
                    .perform(Hint.in("1").withText("Action : convert StaticRouter").withEffort(1)
                                .and(Hint.in("2").withText("In order to replace the use of the StaticRouter in\n" + 
                                            "                    SwitchYard, you should use Camel to route\n" + 
                                            "                    messages.")))
                    .addRule()
                    .when(XmlFile
                    ...
                    .perform(Hint.in("1").withText("Action : convert SOAPProcessor").withEffort(1)
                                .and(Hint.in("2").withText("In order to replace the use of the StaticRouter in\n" + 
                    ...
                    .perform(Hint.in("1").withText("Action : convert SOAPClient").withEffort(1)
                                .and(Hint.in("2").withText("In order to replace the use of the SOAPClient in SwitchYard,\n" + 
