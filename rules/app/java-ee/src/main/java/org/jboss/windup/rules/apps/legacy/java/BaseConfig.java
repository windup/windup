...
public class BaseConfig extends WindupRuleProvider
{
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        ...
        .addRule().perform(
            JavaClassification
            .add(getID(), "Commonj Timer", "commonj.timers.Timer.*", 0, Types.add(ClassCandidateType.EXTENDS_TYPE))
         ...
         */
        .addRule().perform(
            JavaClassification.add(getID(), "Commonj Work", "commonj.work.Work",2, Types.add(ClassCandidateType.EXTENDS_TYPE))
        )
        /*
         ...
         */
        .addRule().perform(
            JavaClassification.add(getID(), "Mule ESB Message Filter","org.mule.umo.UMOFilter$",0, Types.add(ClassCandidateType.EXTENDS_TYPE),
                Link.to("http://camel.apache.org/message-filter.html", "Camel Message Filter"),
                Link.to("http://camel.apache.org/bean-language.html", "Camel Message Bean Filter"))
        )
        /*
         ...
         * </windup:java-classification>
         */
        .addRule().perform(JavaClassification.add(getID(), "JBoss Web Services Specific" , "org.jboss.wsf.*",0, null, 
            Link.to("https://community.jboss.org/wiki/JBossWS4MigrationGuide", "JBoss Web Service (EAP4) Migration Guide"))
        )
        /*
        ...
        .addRule().perform(
            JavaClassification.add(getID(),
                ...
                Types.add(ClassCandidateType.EXTENDS_TYPE), 
                Link.to("http://camel.apache.org/type-converter.html", "Camel Converter"))
        );
