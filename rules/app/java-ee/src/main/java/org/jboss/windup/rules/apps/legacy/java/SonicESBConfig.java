...
public class SonicESBConfig extends WindupRuleProvider
{
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        Configuration configuration = ConfigurationBuilder
                    ...
                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQService").at(TypeReferenceLocation.INHERITANCE))
                    .perform(Hint.withText(null).withEffort(4))

                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQServiceContext").at(TypeReferenceLocation.TYPE))
                    .perform(Hint.withText(null).withEffort(0))

                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQInitContext").at(TypeReferenceLocation.TYPE))
                    .perform(Hint.withText(null).withEffort(1))

                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQInitContext.getParameter").at(
                                            TypeReferenceLocation.METHOD))
                    .perform(Hint.withText("Migrate to Spring property injection.").withEffort(0))

                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQParameters.getParameter").at(
                                            TypeReferenceLocation.METHOD))
                    .perform(Hint.withText("Migrate to Spring property injection.").withEffort(0))
                    ...
                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQMessage.getHeaderValue").at(
                                            TypeReferenceLocation.METHOD))
                    .perform(Hint.withText("Migrate to org.apache.camel.Message.getHeader(String name)")
                                            .withEffort(0))

                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQMessage.setHeaderValue").at(
                                            TypeReferenceLocation.METHOD))
                    ...
                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQMessage.getHeaderNames").at(
                                            TypeReferenceLocation.METHOD))
                    ...
                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQMessage.getPartCount").at(
                                            TypeReferenceLocation.METHOD))
                    .perform(Hint.withText("Migrate to org.apache.camel.Message.getAttachments().size()")
                                            .withEffort(0))

                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQMessage.getPart\\(").at(
                                            TypeReferenceLocation.METHOD))
                    ...
                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQMessage.getCorrelationId").at(
                                            TypeReferenceLocation.METHOD))
                    .perform(Hint.withText(null).withEffort(1))

                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQAddressFactory.createEndpointAddress").at(
                                            TypeReferenceLocation.METHOD))
                    .perform(Hint.withText(null).withEffort(3))

                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQServiceContext.addOutgoing").at(
                                            TypeReferenceLocation.METHOD))
                    .perform(Hint.withText(null).withEffort(1))
                    ...
                    .addRule()
                    .when(JavaClass.references("com.sonicsw.xq.XQEnvelope.getMessage").at(
                                            TypeReferenceLocation.METHOD))
