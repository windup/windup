...
public class SonicESBConfig extends WindupRuleProvider
{
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        ...
        classifications.add(new JavaClassification(getID(), "Sonic ESB Service", "com.sonicsw.xq.XQService", 0, Types.add(TypeReferenceLocation.INHERITANCE)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQService", "<![CDATA[\n" + 
            ...
            "            ]]>", 4, Types.add(TypeReferenceLocation.INHERITANCE)));
        ...
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQInitContext", "<![CDATA[\n" + 
            ...
            "                }\n" + 
            "                ```\n" + 
            "            ]]>", 1, Types.add(TypeReferenceLocation.TYPE)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQInitContext.getParameter", "Migrate to Spring property injection.", 0, Types.add(TypeReferenceLocation.METHOD)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQParameters.getParameter", "Migrate to Spring property injection.", 0, Types.add(TypeReferenceLocation.METHOD)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQParameters", "Migrate to Spring property injection.", 0, Types.add(TypeReferenceLocation.TYPE)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQParameterInfo", "Migrate to Spring property injection.", 0, Types.add(TypeReferenceLocation.TYPE)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQMessage$", "Migrate to org.apache.camel.Message", 0, Types.add(TypeReferenceLocation.TYPE)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQMessage.getHeaderValue", "Migrate to org.apache.camel.Message.getHeader(String name)", 0, Types.add(TypeReferenceLocation.METHOD)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQMessage.setHeaderValue", "Migrate to org.apache.camel.Message.setHeader(String name, Object value)", 0, Types.add(TypeReferenceLocation.METHOD)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQMessage.getHeaderNames", "Migrate to org.apache.camel.Message.getHeaders()", 0, Types.add(TypeReferenceLocation.METHOD)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQPart", "Migrate XQPart to an attachment on the org.apache.camel.Message", 0, Types.add(TypeReferenceLocation.TYPE)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQMessage.getPartCount", "Migrate to org.apache.camel.Message.getAttachments().size()", 0, Types.add(TypeReferenceLocation.METHOD)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQMessage.getPart\\(", "Migrate to org.apache.camel.Message.getAttachment(String id)", 0, Types.add(TypeReferenceLocation.METHOD)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQLog", "Migrate to SLF4J.", 1, Types.add(TypeReferenceLocation.TYPE)));
        ...
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQAddressFactory.createEndpointAddress", "<![CDATA[\n" + 
            ...
            "            ]]>", 3, Types.add(TypeReferenceLocation.METHOD)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQServiceContext.addOutgoing", "<![CDATA[\n" + 
            ...
            "            ]]>", 1, Types.add(TypeReferenceLocation.METHOD)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQEnvelope", "Migrate to org.apache.camel.Exchange", 0, Types.add(TypeReferenceLocation.TYPE)));
        hints.add(new BlackListRegex(getID(), "com.sonicsw.xq.XQEnvelope.getMessage", "Migrate to com.sonicsw.xq.XQEnvelope.getMessage.getIn()", 0, Types.add(TypeReferenceLocation.METHOD))); 
