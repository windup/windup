    ...
    public Configuration getConfiguration(GraphContext context)
    {
        ...
        Configuration configuration = ConfigurationBuilder
                    ...
                    .perform(Iteration.over()
                                .perform(Hint.havingText("Upgrade to javax.util.concurrent in Java 5+").withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration.over()
                                .perform(Hint.havingText("Ensure class is available to JBoss").withEffort(1)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration.over().perform(Hint.havingText("Oracle-specific SQL code").withEffort(1)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration.over().perform(Hint.havingText("Remove import").withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration
                                .over()
                                .perform(Hint.havingText("SCA Bean Injection; replace with Spring Bean Injection")
                                            .withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration
                                .over()
                                .perform(Hint
                                            .havingText("SCA Initialization Hook; Use the property: init-method='example' on the Spring Bean, where example is the initialization method")
                                            .withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration
                                .over()
                                .perform(Hint
                                            .havingText("SCA Destroy Hook; Use the property: destroy-method='example' on the Spring Bean, where example is the destroy method")
                                            .withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration.over().perform(Hint.havingText("IBM CICS Adapter").withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .when(
                                JavaClass.references("((javax.naming.InitialContext)|(javax.naming.Context)).lookup")
                                            .at(TypeReferenceLocation.METHOD))
                    .perform(Iteration.over().perform(Hint.havingText("<![CDATA[\n" + 
                    ...
                    .perform(Iteration
                                .over()
                                .perform(Hint
                                            .havingText("Ensure that the InitialContext connection properties do not need to change for JBoss")
                                            .withEffort(1)
                                )
                                .endIteration()
                    )
                    ...
                    .when(
                                JavaClass.references("javax.management.ObjectName\\(.+\\)").at(
                                            TypeReferenceLocation.CONSTRUCTOR_CALL))
                    .perform(Iteration.over()
                                .perform(Hint.havingText("Ensure that the ObjectName exists in JBoss").withEffort(1)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration
                                .over()
                                .perform(Hint
                                            .havingText("Move to a JCA Connector unless this class is used for batch processes, then refactor as necessary")
                                            .withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration.over().perform(Hint.havingText("Migrate to JCA Connector").withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration
                                .over()
                                .perform(Hint.havingText("Tibco specific annotation; replace with javax.jws.WebParam")
                                            .withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .when(
                                JavaClass.references("com.tibco.amf.platform.runtime.extension.exception.SOAPCode$")
                                            .at(TypeReferenceLocation.NOTSPECIFIED))
                    .perform(Iteration.over().perform(Hint.havingText("Tibco specific annotation").withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration
                                .over()
                                .perform(Hint
                                            .havingText("Tibco specific annotation; replace with javax.jws.WebService")
                                            .withEffort(0)
                                )
                                .endIteration()
                    )
                    ...
                    .perform(Iteration
                                .over()
                                .perform(Hint.havingText("Tibco specific annotation; replace with javax.jws.WebMethod")
                                            .withEffort(0)
                                )
                                .endIteration()
                    )
