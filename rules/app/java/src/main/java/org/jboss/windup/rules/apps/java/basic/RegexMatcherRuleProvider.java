...
public class RegexMatcherRuleProvider extends WindupRuleProvider
{
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        return ConfigurationBuilder
                    ...
                    .addRule()
                    .when(
                                GraphSearchConditionBuilder.create("javaFiles").ofType(JavaFileModel.class)
                                            .withProperty("analyze", true)
                    )
                    .perform(
                                Iteration.over("javaFiles")
                                            .as("javaFile")
                                            .perform(
                                                        // A nested rule.
                                                        GraphSubset.evaluate(
                                                                    ConfigurationBuilder
                                                                                ...
                                                                                .perform(
                                                                                            Iteration.over("regexes")
                                                                                                        .as(RegexModel.class,
                                                                                                                    "regex")
                                                                                                        .perform(
                                                                                                                    new AbstractIterationOperation<RegexModel>(
                                                                                                                                RegexModel.class,
                                                                                                                                "regex")
                                                                                                                    {
                                                                                                                        @Override
                                                                                                                                    ...
                                                                                                                                    RegexModel regex)
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            VarStack sf = VarStack
                                                                                                                                        .instance(event);
                                                                                                                            JavaFileModel javaFile = Iteration
                                                                                                                                        .getCurrentPayload(
                                                                                                                                                    sf,
                                                                                                                                                    JavaFileModel.class,
                                                                                                                                                    "javaFile");
    ...
    /**
     * Returns all regex matches in the given file. TODO: Perhaps keep the compiled regex'es.
     */
