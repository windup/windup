...
public class JavaEEBasicHintsRuleProvider extends WindupRuleProvider
{
    @Override
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        ...
        .addRule()
        .when(JavaClass.references("org.mule.umo.UMOMessage.getPayload.+").at(TypeReferenceLocation.METHOD))
