...
public class JavaEE_SeamToCdiRules extends WindupRuleProvider
{
    @Override
    public void enhanceMetadata(Context context)
    {
        super.enhanceMetadata(context);
        context.put(RuleMetadata.CATEGORY, "JavaEE/Seam");
    }
    ...
    public Configuration getConfiguration(GraphContext context)
    {
        ...
        .perform(Classification.as("SEAM Component").with(
            ...
            .with(Link
                .to("JSF Web Application Example", "http://docs.jboss.org/weld/reference/latest/en-US/html/example.html"))
                .with(Link.to("JBoss Context Documentation", "http://docs.jboss.org/weld/reference/latest/en-US/html/contexts.html"))
                .with(Link.to("CDI Conversations Blog Post", "http://www.andygibson.net/blog/tutorial/cdi-conversations-part-2/"))
            .withEffort(1)
        )
        ...
        .addRule()
        .when(JavaClass.references("org.jboss.seam.core.Conversation").at(TypeReferenceLocation.IMPORT))
        ...
        .addRule()
        .when(JavaClass.references("org.jboss.seam.core.ConversationEntries").at(TypeReferenceLocation.IMPORT))
