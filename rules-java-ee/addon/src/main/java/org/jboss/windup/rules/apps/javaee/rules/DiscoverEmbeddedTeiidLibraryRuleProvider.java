...
@RuleMetadata(phase = InitialAnalysisPhase.class, perform = "Discover TEIID libraries embedded")
public class DiscoverEmbeddedTeiidLibraryRuleProvider extends AbstractRuleProvider
{
    ...
    public Configuration getConfiguration(RuleLoaderContext context)
    {
        ...
        return ConfigurationBuilder.begin()
                    ...
                    .when(Query.fromType(JarArchiveModel.class)
                                .withProperty(FileModel.FILE_NAME, QueryPropertyComparisonType.REGEX, ".*teiid.*\\.jar$"))
                    .perform(
                                new AbstractIterationOperation<JarArchiveModel>()
                                {
                                    public void perform(GraphRewrite event, EvaluationContext context, JarArchiveModel fileResourceModel)
                                    {
                                        ...
                                        technologyTagService.addTagToFileModel(fileResourceModel, "Teiid (embedded)",
