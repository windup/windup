...
/**
 * Discovers JBoss EJB XML files and parses the related metadata
 * Handles XML files prior to EAP 6. (jboss-ejb.xml)
 * 
...
public class ResolveJBossEjbXmlRuleProvider extends IteratingRuleProvider<XmlFileModel>
{
    ...
    {
        return Query.fromType(XmlFileModel.class).withProperty(XmlFileModel.ROOT_TAG_NAME, "ejb-jar").withProperty(FileModel.FILE_NAME, "jboss-ejb3.xml");
    }
