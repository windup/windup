...
import org.jboss.windup.decorator.xml.XPathClassifyingDecorator;
...
public class XPathClassifyingBeanParser extends AbstractBeanDefinitionParser {
	private static final Logger LOG = LoggerFactory.getLogger(XPathClassifyingBeanParser.class);

	@Override
	protected AbstractBeanDefinition parseInternal(Element element, ParserContext parserContext) {
		BeanDefinitionBuilder beanBuilder = BeanDefinitionBuilder.rootBeanDefinition(XPathClassifyingDecorator.class);
