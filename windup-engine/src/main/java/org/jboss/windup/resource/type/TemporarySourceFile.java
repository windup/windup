...
public class TemporarySourceFile extends FileMeta {
	private static final Log LOG = LogFactory.getLog(TemporarySourceFile.class);
	
	private final File source;
	
	public TemporarySourceFile(File source) {
		this.source = source;
	}
