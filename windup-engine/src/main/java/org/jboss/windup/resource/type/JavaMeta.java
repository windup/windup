...
/**
 * Extends the FileMeta, keeps track of Java class specific information including class dependencies
 * and blacklisted dependencies.
 * 
 * @author bdavis
 * 
 */
public class JavaMeta extends FileMeta {
	...
	public String toString() {
		return "JavaMeta [qualifiedClassName=" + qualifiedClassName + ", classDependencies=" + classDependencies + ", blackListedDependencies="
