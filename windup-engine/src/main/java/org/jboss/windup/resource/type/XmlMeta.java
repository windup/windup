 ...
 * This allows XPath Queries and XSLT reports to generate extremely fast against the XmlMeta data in the
 * decorator pipeline.
 * 
 ...
 * 
 */
public class XmlMeta extends FileMeta {
	private static final Log LOG = LogFactory.getLog(XmlMeta.class);
	...
	public String toString() {
		return "XmlMeta [decorations=" + decorations + ", filePointer=" + filePointer + "]";
	}
}
