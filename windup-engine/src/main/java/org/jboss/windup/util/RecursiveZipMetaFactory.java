...
public class RecursiveZipMetaFactory {
	 ...
	 *            {@link ZipMeta} generated by this recursive extraction.
	 * @param zip
	 *            {@link ZipFile} to recursively extract.
	 * 
	 * @return {@link ZipMeta} generated from recursively extracting the given
	 *         {@link ZipFile}. Will have the optional given parent meta as
	 *         parent archive meta.
	 */
	public ZipMeta recursivelyExtract(ArchiveMeta parentMeta, ZipFile zip) {

		if (LOG.isDebugEnabled()) {
			LOG.debug(zip.getName() + ": " + this.startLocation.getAbsolutePath());
		}
		
		ZipMeta archive = generateArchive(parentMeta, new File(zip.getName()));
	...
	private ZipMeta generateArchive(ArchiveMeta parent, File entryOutput) {
