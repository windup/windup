 ...
 * 
 * A <code>LineNumberFormatter</code> is used to rewrite an existing .java file, introducing line number information. It
...
class LineNumberFormatter
{
    ...
    private void emitFormatted(List<String> brokenLines, List<LineNumberPosition> lineBrokenPositions)
                throws IOException
    {
