...
public final class DeploymentInfo {
     ...
     */
    public DeploymentInfo( String deplPath ) throws WindupException {
     ...
     *  Also, type is derived from name, and canonical file is derived for map keys.
     */
    public DeploymentInfo( File deplPath ) throws WindupException {
        try {
            this.canonicalFile = deplPath.getCanonicalFile();
        } catch( IOException | NullPointerException ex ) {
            throw new WindupException( "Failed resolving canonical path for the deployment " + deplPath + ":\n    " + ex.getMessage(), ex );
        }
    ...
    public File unzipToTmpDir() throws WindupException {
