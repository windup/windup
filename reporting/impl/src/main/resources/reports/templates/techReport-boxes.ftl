...
<head>
    ...
    <style>
        ...
        table.technologiesBoxCard td.heading {
        ...
        tr.sectorsHeaders > td {
            text-align: center;
            padding: 10pt 20pt 0;
        }

        /* Around the sector header box. */
        tr.rowSectors > td {
            padding: 2ex 2em;
        }

        tr.sectorsHeaders > td div {
            text-align: center;
            padding: 1ex 2em;
        }
        ...
        tr.rowSectors > td > div.box {
            padding: 8pt 18pt 8pt 12pt;
            margin-bottom: 10pt;
        }

        tr.rowSectors > td > div.box > h4 {
            font-size: 12pt;
            font-weight: bold;
        }

        tr.rowSectors .box h4 {
            font-size: 12pt;
            font-weight: bold;
            text-align: right;
        }

        tr.rowSectors .box ul li {
            font-size: 12px;
        }
        ...
        tr.rowSectors .box .content {
            margin-left: 62px;
        }

        tr.rowSectors .box .content ul {
            list-style: none;
            margin: 0;
            -webkit-padding-start: 10px;
        }

        tr.rowSectors .box .content ul li {
            margin: 0;
            text-align: right;
        }

        tr.rowSectors .box .content ul li b {
            width: 3ex;
            ...
            <table class="technologiesBoxCard">
                ...
                <#list rowTags as rowTag> <#-- currently Java EE / Embedded -->
                    <tr class="rowHeader row-${rowTag.name}">
                        <td class="heading" colspan="${sectorTags?size}">
                            <div>${rowTag.title}</div>
                        </td>
                    </tr>
                    <tr class="rowSectors">
                        <#list sectorTags as sectorTag>
