    ...
    <svg class="app-topology" hidden>
        <defs>
            <g class="Ear" id="vertex-Ear">
                ...
                <text y="8" x="-0.5" fill="#0B3C5D" font-family="PatternFlyIcons-webfont" font-size="18px"
                      text-anchor="middle">&#xe918;
                </text>
            </g>
            <g class="WarApp" id="vertex-WarApp">
                <circle r="15" fill="#fff" stroke="#aaa"></circle>
                <text y="5" x="0.5" fill="#0B3C5D" font-family="FontAwesome" font-size="16px" text-anchor="middle">
                    &#xf1b3;
                </text>
            </g>
            <g class="War" id="vertex-War">
                <circle r="15" fill="#fff" stroke="#aaa"></circle>
                <text y="5" x="0.5" fill="#328CC1" font-family="FontAwesome" font-size="16px" text-anchor="middle">
                    &#xf1b3;
                </text>
            </g>
            ...
            <#if reportModel.projectModel??>
                <g class="ExternalJar" id="vertex-ExternalJar">
                    <circle r="15" fill="#fff" stroke="#aaa"></circle>
                    <text y="5" x="0.5" fill="#D9B310" font-family="FontAwesome" font-size="16px" text-anchor="middle">
                        &#xf1b2;
                    </text>
                </g>
            </#if>
