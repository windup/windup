            ...
            <h1>
                <div class="main">Classloader Report
                    <i class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement=right
                       title="The classloader report shows the relations between classloaders and the loaded types, and highlights the conditions which often lead to problems, like: duplicated classes, classes not found in the application, blacklisted classes."></i>
                </div>
    ...
    <#list classloader.classes>
        <div class="panel panel-primary">
            ...
            <table class="table table-striped table-bordered">
                <tr>
                    <th>${classloader.referencedFrom}</th>
                    <th>${classloader.referenceType}</th>
                </tr>
                <#items as clz>
                    <tr>
                        <td>${clz.clzName}</td>
                        <td>
                            <#list clz.references>
                                <table>
                                    <#items as reference>
                                        <tr>${reference.referenceType}
                                            <td></td>
                                            <td>${reference.clzName}</td>
                                        </tr>
                                    </#items>
                                </table>
                            </#list>
