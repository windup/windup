...
<div class="container-fluid" role="main">
    ...
    <div class="row">
        <iframe style="width:100%; height: 100%; position:absolute;border-width: 0px;padding-left: 15px;padding-right: 15px;"
                src="${reportModel.reportProperties.embeddedUrl}"></iframe>
    </div>
</div>
