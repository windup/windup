...
public class GraphExporter
{
    ...
    public void renderVizjs(File output, String vertexLabelProperty, String edgeLabel) throws FileNotFoundException,
                IOException
    {
    ...
    public void renderSigma(File output, String vertexLabelProperty, String edgeLabel) throws FileNotFoundException,
                IOException
    {
    ...
    public void renderDagreD3(File output, String vertexLabelProperty, String edgeLabel) throws FileNotFoundException,
                IOException
    {
