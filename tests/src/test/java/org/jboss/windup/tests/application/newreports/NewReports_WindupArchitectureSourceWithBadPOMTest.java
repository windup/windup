...
public class NewReports_WindupArchitectureSourceWithBadPOMTest extends WindupArchitectureTest {
    @Deployment
    @AddonDependencies({
    ...
    public void testRunWindupSourceMode() throws Exception {
        try (GraphContext context = createGraphContext()) {
            ...
            super.runTest(context, false, "../test-files/src_example_bad_maven", true);
        }
    }
}
