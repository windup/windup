...
public abstract class AbstractBootstrapTestWithRules extends AbstractBootstrapTest {
    private static final String TESTING_MIGRATION_RULES = "<?xml version=\"1.0\"?>\n"
            ...
            + "            </when>\n"
            + "            <perform>\n"
            + "                <classification issue-display-mode=\"all\" title=\"jboss-web.xml\" effort=\"3\" severity=\"mandatory\"/>\n"
            + "            </perform>\n"
            + "        </rule>\n"
            + "    </rules>\n"
            + "</ruleset>";
    ...
    private static final String MORE_TESTING_MIGRATION_RULES = "<?xml version=\"1.0\"?>\n"
            ...
            + "            </when>\n"
            + "            <perform>\n"
            + "                <classification issue-display-mode=\"all\" title=\"jboss-ejb3.xml\" effort=\"3\" severity=\"mandatory\"/>\n"
            + "            </perform>\n"
            + "        </rule>\n"
            + "    </rules>\n"
            + "</ruleset>";
