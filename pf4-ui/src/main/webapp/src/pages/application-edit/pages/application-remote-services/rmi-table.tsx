...
import { RmiServiceDto } from "@app/api/application-remote-services";
...
export interface IRMITableProps {
  applicationId: string;
}

export const RMITable: React.FC<IRMITableProps> = ({ applicationId }) => {
  // Filters
  ...
  const { pageItems, filteredItems } = useTable<RmiServiceDto>({
    items: beans,
