== config-java
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The config-java addon enables blah blah...)
...
<dependency>
   ...
   <artifactId>windup-config-java</artifactId>
